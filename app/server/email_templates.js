...
Accounts.emailTemplates.enrollAccount.text = function(user, url) {
  ...
  return greeting + "\n"
    + "\n"
    + "Nous venons de changer la plateforme technique qui gère le projet 'ladditionestpourmoi.fr', de nouvelles évolutions sont arrivées et d'autres encore sont dans les tuyaux.\n"
    + "\n"
    + "Votre compte a bien été rapatrié et toutes vos données (email, nom, description) ont bien été migrées ! Il y a juste le mot de passe qui a été modifié : il vous suffit donc de cliquer sur le lien ci-desous pour remettre un nouveau mot de passe.\n"
    + "\n"
    + url + "\n"
    + "\n"
    + "Profitez-en pour mettre à jour votre profil, mettre des tags, mettre une vraie photo (seuls les profils avec de vraies photos seront listés).\n"
    + "\n"
